...
Future<bool?> showEditOfficeDialog(
...
class _EditOfficeDialog extends StatefulWidget {
  final Office office;
  final OfficesService service;

  const _EditOfficeDialog({
    required this.office,
    required this.service,
  });

  @override
  State<_EditOfficeDialog> createState() => _EditOfficeDialogState();
}

class _EditOfficeDialogState extends State<_EditOfficeDialog> {
  ...
  void initState() {
    super.initState();
    _controller = TextEditingController(text: widget.office.officeName);
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      await widget.service.editOfficeName(
        EditOfficeRequest(
          officeId: widget.office.officeId,
          officeName: _controller.text.trim(),
        ),
      );
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(tr(context, 'edit_office'), style: titleStyle),

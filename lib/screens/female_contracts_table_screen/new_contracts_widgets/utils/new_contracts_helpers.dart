...
bool isOver7DaysWithoutApprove(FemaleContract c) {
...
String adminRequestsStatusText(FemaleContract c) {
...
bool actionsDisabled(FemaleContract c) {
  return (c.adminRequestsStatus == 1 || c.adminRequestsStatus == 4);
}

String itemKey(FemaleContract c) {

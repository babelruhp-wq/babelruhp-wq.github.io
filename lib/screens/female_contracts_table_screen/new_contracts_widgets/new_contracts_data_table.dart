...
import '../under_process_widgets/utils/cairo_theme.dart'; // ✅ نفس Theme بتاع UnderProcess

import '../under_process_widgets/dialogs/note_dialog.dart';
import 'dialogs/approve_dialog.dart';
import 'utils/new_contracts_helpers.dart' as h;
import 'widgets/new_contracts_actions.dart';

class NewContractsDataTable extends StatefulWidget {
  ...
  final Future<void> Function(FemaleContract c, int cancelationBy, String reason)
  onCancel;

  const NewContractsDataTable({
    super.key,
    required this.items,
  ...
  @override
  State<NewContractsDataTable> createState() => _NewContractsDataTableState();
}

class _NewContractsDataTableState extends State<NewContractsDataTable> {

  // ✅ نفس Grid color بتاع UnderProcess
  ...
  late List<FemaleContract> _items;
  ...
  void initState() {
    super.initState();
    _items = List<FemaleContract>.from(widget.items);
  }

  @override
  void didUpdateWidget(covariant NewContractsDataTable oldWidget) {
  ...
  void _removeItem(FemaleContract c) {
    final k = h.itemKey(c);
    _items.removeWhere((x) => h.itemKey(x) == k);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final searched = _utils.applySearch(_items, _query);
    ...
    return Theme(
      data: cairoTheme(context), // ✅ نفس Theme
      child: Column(
        children: [
          // =========================
          ...
          // =========================
          // ✅ Table Card (Pro) (زي UnderProcess)
          // =========================
          Expanded(
            child: Container(
              decoration: BoxDecoration(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                            const Color(0xFF7A5AF8).withOpacity(.15),
                          ),
                        ),
                        ...
                        child: Theme(
                          ...
                          child: DataTable(
                            ...
                            columns: [
                              ...
                              if (isAdmin || isManager||isReceptionEmployee)
                              DataColumn(
                                label: _cells.headerCell(
                                  tr(context, 'actions'),
                                  w: 500,
                            ...
                            rows: List.generate(pageItems.length,
                                  ...
                                  final danger =
                                  h.isOver7DaysWithoutApprove(c);
                                  final disabled = h.actionsDisabled(c);
  ...
  // =========================
  // ✅ Admin Request Chip (نفس UnderProcess)
  // =========================

...
import 'table_chips.dart';
import 'table_utils.dart';

class FemaleContractsDataTable extends StatefulWidget {
  ...
  const FemaleContractsDataTable({
    super.key,
    required this.items,
  ...
  @override
  State<FemaleContractsDataTable> createState() =>
      _FemaleContractsDataTableState();
}

class _FemaleContractsDataTableState extends State<FemaleContractsDataTable> {

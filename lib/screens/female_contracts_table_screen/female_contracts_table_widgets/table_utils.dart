...
class TableUtils {
  ...
  List<FemaleContract> applySearch(List<FemaleContract> list, String query) {
  ...
  List<FemaleContract> applySort({
    required List<FemaleContract> list,
    ...
    int compare(FemaleContract a, FemaleContract b) {
      int r = 0;

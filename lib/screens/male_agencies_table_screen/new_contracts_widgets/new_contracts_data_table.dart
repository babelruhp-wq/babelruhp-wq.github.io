...
class NewContractsDataTable extends StatefulWidget {
  ...
  final Future<void> Function(MaleAgency c, int cancelationBy, String reason)
  onCancel;
...
class _NewContractsDataTableState extends State<NewContractsDataTable> {
  ...
  void initState() {
    super.initState();
    _items = List<MaleAgency>.from(widget.items);
  }

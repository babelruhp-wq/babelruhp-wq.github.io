...
class OfficeMaleAgenciesDetailsCardWidget extends StatefulWidget {
  final Map<String, dynamic> item;
  final int? number; // null = loading
  final VoidCallback? onTap;

  const OfficeMaleAgenciesDetailsCardWidget({
    super.key,
    required this.item,
  ...
  @override
  State<OfficeMaleAgenciesDetailsCardWidget> createState() =>
      _OfficeMaleAgenciesDetailsCardWidgetState();
}

class _OfficeMaleAgenciesDetailsCardWidgetState
    extends State<OfficeMaleAgenciesDetailsCardWidget> {
  bool _hovered = false;

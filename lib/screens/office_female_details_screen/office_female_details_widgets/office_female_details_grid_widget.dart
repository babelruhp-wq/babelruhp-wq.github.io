...
import 'office_female_details_card_widget.dart';

class OfficeFemaleDetailsGridWidget extends StatelessWidget {
  ...
  const OfficeFemaleDetailsGridWidget({
    super.key,
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
          ...
          child: OfficeFemaleDetailsCardWidget(
            item: item,
